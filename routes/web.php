...
Route::prefix('admin')->name('admin.')->middleware(['web', 'admin'])->group(function () {
    ...
    Route::get('invoice/{order}/generate', [\App\Http\Controllers\Admin\OrderController::class, 'generateInvoice'])->name('invoice.generate');
    Route::get('invoice/{order}', [\App\Http\Controllers\Admin\OrderController::class, 'viewInvoice'])->name('invoice.view');
    // Technical Support
