...
@section('title', 'إضافة رقم هاتف جديد')
...
<div class="max-w-2xl mx-auto animate-fade-in">
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-slate-800">إضافة رقم هاتف جديد</h2>
    </div>

    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="{{ route('admin.phone_numbers.store') }}" method="POST" class="p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="phone_number" name="phone_number" value="{{ old('phone_number') }}" placeholder="أدخل رقم الهاتف">
                    @error('phone_number')
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
                    <button type="submit" class="px-8 py-3 bg-primary-start hover:bg-primary-end text-white font-bold rounded-2xl shadow-lg hover:shadow-primary-start/30 transition-all-300 flex-1 flex justify-center items-center">
                        <i class="fas fa-save ml-2"></i> حفظ الرقم
                    </button>
