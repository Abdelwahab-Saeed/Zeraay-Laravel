                ...
                <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" 
                                       {{ !auth()->user()->isAdmin() ? 'readonly ' . (old('price') ? '' : 'value=0') : '' }}
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" 
                                       {{ !auth()->user()->isAdmin() ? 'readonly ' . (old('discount_price') ? '' : 'value=0') : '' }}
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" 
                                       ...
                                       id="cost_price" name="cost_price" value="{{ old('cost_price') }}" placeholder="0.00">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs uppercase">ج.م</span>
                            </div>
                            @error('cost_price')
                                <p class="mt-1 text-xs text-rose-500 font-medium">{{ $message }}</p>
