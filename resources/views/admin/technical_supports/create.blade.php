...
@section('title', 'إضافة مسؤول دعم فني')
...
<div class="max-w-3xl mx-auto animate-fade-in">
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-slate-800">إضافة مسؤول دعم فني جديد</h2>
    </div>

    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="{{ route('admin.technical_supports.store') }}" method="POST" novalidate class="p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="name" name="name" value="{{ old('name') }}" placeholder="أدخل اسم المسؤول">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           id="phone" name="phone" value="{{ old('phone') }}" placeholder="أدخل رقم الهاتف">
                    @error('phone')
                        <p class="mt-1 text-xs text-rose-500 font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-100">
                    <button type="submit" class="px-8 py-3 bg-primary-start hover:bg-primary-end text-white font-bold rounded-2xl shadow-lg hover:shadow-primary-start/30 transition-all-300 flex-1 flex justify-center items-center">
                        <i class="fas fa-save ml-2"></i> حفظ المسؤول
                    </button>
